...
function MemberManagement() {
  ...
  const handleLeaveCourse = (userId, firstName, lastName) => {
      ...
      const updateAnnouncement = async () => {
        try {
          ...
          const date =
            ...
            minutes;
          const mess =
            "Admin " + "đã xóa " + firstName + " " + lastName + " ra khỏi nhóm";
      ...
      const updateAnnouncementUser = async () => {
        try {
          ...
          const mess =
            ...
            // " " +
            // user.lastName +
            " Bạn đã bị xóa khỏi nhóm " + course.name;
          const response = fetch(
  ...
  const handleBan = (userId, firstName, lastName) => {
      ...
      const updateAnnouncement = async () => {
        try {
          ...
          const mess =
            ...
            " " +
            lastName +
            " ra khỏi nhóm và cấm vĩnh viễn vào lại nhóm";
          const response = fetch(
            `http://localhost:3001/courses/${courseId}/announcement`,
            {
              method: "PUT",
      ...
      const updateAnnouncementUser = async () => {
        try {
          ...
          const mess =
            ...
            // " " +
            // user.lastName +
            " Bạn đã bị xóa khỏi nhóm và bị cấm vĩnh viễn vào lại nhóm  " +
            course.name;
          const response = fetch(
            `http://localhost:3001/users/${userId}/announcement`,
            {
                ...
                <>
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{ padding: "5px 10px", fontSize: "13px" }}
                      onClick={() =>
                        handleBan(data._id, data.firstName, data.lastName)
                      }
                    >
                      Cấm Vĩnh Viễn
                    </button>
